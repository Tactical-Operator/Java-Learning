...
class Item_not_found_exception extends Exception {
        ...
        while (true) {
            ...
            while (true) {
                ...
                try {
                    ...
                    String item_input = sc.nextLine(); // accpeting user input
            ...
            if (exit.equalsIgnoreCase("exit")) {
                System.out.println("Exiting shopping cart,Do Visit Again, Thank YOU");
                break;
            }
        }
        sc.close();
